...
def explain_model(
    model: Any, 
    X_test: pd.DataFrame, 
    mode: Literal['summary', 'bar', 'both'] = 'both'
) -> shap.Explanation:
    """
    ...
    # extract solely model from overall pipeline
